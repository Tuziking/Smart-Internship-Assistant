...
import com.example.smart_internship_assistant.Result;
import com.example.smart_internship_assistant.User;
import com.example.smart_internship_assistant.view.CodeInputDialog;
import com.example.smart_internship_assistant.view.CodeInputView;
...
//                    sendRequest(mail, password, confirm, username);
    ...
    private void sendRequest(String mail, String password, String confirm, String username) {
//        FormBody body = new FormBody.Builder()
//                .add("mail", mail)
//                .add("name", username)
...
//                .build();
        ...
        // 创建请求体，设置Content-Type为application/json
        MediaType JSON = MediaType.get("application/json; charset=utf-8");
        RequestBody body = RequestBody.create(jsonString, JSON);
        Request request = new Request.Builder()
                .url("http://" + Constants.IP_ADDRESS + "/auth/" + "register")
                .post(body)
                .build();
        OkHttpClient client = new OkHttpClient();
        client.newCall(request).enqueue(new Callback() {

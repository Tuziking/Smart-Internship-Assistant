...
import com.B0BO.smart_internship_assistant.utils.SharedPreferenceHelper;
...
//                String password = "123456";
                ...
                Request request = new Request.Builder()
                        .url("http://" + Constants.IP_ADDRESS + "/" + "login")
                        .post(body)
                        .build();
...
//                                Intent intent = new Intent(LoginActivity.this, ChatTest.class);
